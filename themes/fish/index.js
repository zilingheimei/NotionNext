...
const LayoutBase = props => {
  ...
  return (
        <div id='theme-hexo'>
            ...
            {/* 主区块 */}
            <main id="wrapper" className={`${CONFIG.HOME_BANNER_ENABLE ? '' : 'pt-16'} bg-white dark:bg-black w-full py-8 md:px-8 lg:px-24 min-h-screen relative`}>
...
const LayoutArchive = (props) => {
  ...
  return <LayoutBase {...props} className='pt-8'>
        <Card className='w-full'>
            <div className="mb-10 pb-20 bg-white/75 md:p-12 p-3 min-h-full dark:bg-hexo-black-gray">
